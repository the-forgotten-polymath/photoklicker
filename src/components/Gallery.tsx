...
const galleryImages = [
  { id: 1, src: '/images/image_4.jpg', category: 'Pre Wedding', alt: 'Pre Wedding romance' },
  { id: 2, src: '/images/image_5.jpg', category: 'Wedding', alt: 'Mandap sacred pheras' },
  { id: 3, src: '/images/image_6.jpg', category: 'Portraits', alt: 'Bridal silk portrait' },
  { id: 4, src: '/images/image_7.jpg', category: 'Maternity', alt: 'Ethereal Maternity Shoot' },
  { id: 5, src: '/images/image_8.jpg', category: 'Baby', alt: 'Soft baby smile portrait' },
  { id: 6, src: '/images/image_9.jpg', category: 'Wedding', alt: 'Ring Ceremony sparkle' },
  { id: 7, src: '/images/image_10.png', category: 'Wedding', alt: 'Heritage grand wedding' },
  { id: 8, src: '/images/image_11.jpg', category: 'Pre Wedding', alt: 'Scenic mountain session' },
  { id: 9, src: '/images/image_12.jpg', category: 'Portraits', alt: 'Close-up glance portrait' },
  { id: 10, src: '/images/image_13.jpg', category: 'Wedding', alt: 'Haldi traditional rituals' },
  { id: 11, src: '/images/image_14.jpg', category: 'Pre Wedding', alt: 'Sunset silhouettes Tehri' },
  { id: 12, src: '/images/image_15.jpg', category: 'Portraits', alt: 'Sartorial studio portrait' }
];

const categories = ['All', 'Wedding', 'Pre Wedding', 'Portraits', 'Maternity', 'Baby'];
        ...
        >
          {categories.map((cat) => (
            <button
              ...
              className="px-6 py-2.5 rounded-full text-xs font-medium tracking-wide uppercase transition-all duration-300 active:scale-95 cursor-pointer bg-bg-card hover:bg-border-color text-text-dark"
              style={{
                backgroundColor: activeCategory === cat ? '#C9540A' : '',
                color: activeCategory === cat ? '#FFFFFF' : ''
              }}
            >
              {cat}
            </button>
